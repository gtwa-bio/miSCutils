# Getting help with `miSCutils`

Thank you for using `miSCutils`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/miSCutils`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/miSCutils),
...
[search issues and pull requests](https://github.com/gtwa-bio/miSCutils/issues)
